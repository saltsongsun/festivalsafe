...
function AuthenticatedApp({ session, accounts, setAccounts, onLogout, initialPage, setPage: setPageExt }) {
  ...
  return (<div className="desktop-scale" style={{ fontFamily: "'Noto Sans KR',-apple-system,sans-serif" }}>
...
@media(min-width:768px){
  body{font-size:16px}
  .desktop-scale{zoom:1.1}
}
@media(min-width:1200px){
  .desktop-scale{zoom:1.15}
}
`}</style>
